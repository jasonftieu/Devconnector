...
router.post(
  "/",
  // Using passport.authenticate because it is a protected route
  passport.authenticate("jwt", { session: false }),
  (req, res) => {
    ...
    // Check Validation
    if (!isValid) {
      // Return any errors with 400 stats
    ...
    // Social
    profileFields.social = {}; // Profile Object containing social media
